...
if(isset($_POST['submit'])) {
    ...
    // SQL query
    $insertQuery = "INSERT INTO events_details(event_name, event_location, event_date, event_obj, event_coordinator, event_number, event_mail, event_budget) 
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = $events_db->prepare($insertQuery);

    $stmt->bind_param("ssssssss", $event_name, $event_location, $event_date, $event_obj, $co_name, $co_num, $co_email, $event_bud);
          ...
          <div class="col-xl-10 col-lg-8">
            <div class="card shadow mb-4" >
              ...
              <tbody>
                <tr>
                  <td bgcolor="#004AAD">
                    <h3 class="textsizecss">ADD EVENT</h3>
                  </td>
              </tr>
             </tbody>
           </table>
           ...
           <form name = "form" id="insert_form_action" action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" onsubmit="return validateEmail()">
             <div class="col-md-12">
              ...
              <div class="col-md-6">
                ...
                <input type="text" name="event_location" class="form-control" id="event_location" placeholder="Event Location" required/>
              </div>
             ...
             <div class="col-md-6 mt-3">
                ...
                <input type="text" name="event_obj" class="form-control" id="event_obj" placeholder="Event Objective" value="">
              </div>

              <div class="col-md-6 mt-3">
                <label for="event_bud" class="required">Event Budget</label>
                <input type="text" name="event_bud" class="form-control" id="event_bud" placeholder="Event Budget" value="" maxlength="10" required oninput="validatePhoneNumber(this)"/>
              </div>
               ...
               <h4 style="color: black;">Early Event Planning:</h4>
                ...
                <input type="text" name="co_name" class="form-control"id="co_name" placeholder="Event Coordinator" required/>
              </div>

              <div class="col-md-6">
                <label for="co_num" class="required">Contact Phone Number</label>
                <input type="tel" name="co_num" class="form-control" id="co_num" placeholder="Contact Phone Number" maxlength="10" required oninput="validatePhoneNumber(this)"/>
              </div>

              <div class="col-md-6 mt-3">
                <label for="co_email">Email</label>
                <input type="email" name="co_email" class="form-control" id="co_email" placeholder="Email" />
